...
public class ViewRenderService : IViewRenderService
{
    ...
    public ViewRenderService(IRazorViewEngine razorViewEngine, ITempDataProvider tempDataProvider,
        IServiceProvider serviceProvider, IWebHostEnvironment env, IHttpContextAccessor ctx)
    {
    ...
    {
        var httpContext = _ctx.HttpContext ?? new DefaultHttpContext { RequestServices = _serviceProvider };
