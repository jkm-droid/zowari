...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220809113139_AddExtraFieldsInUsers")]
    partial class AddExtraFieldsInUsers
    {
            ...
            modelBuilder.Entity("Domain.Entities.Identity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("a61387a3-7379-4776-b5ab-7c76ac6ad031"),
                            ConcurrencyStamp = "41242bd9-e80e-476d-9831-911711df7edd",
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 8, 9, 11, 31, 39, 34, DateTimeKind.Unspecified).AddTicks(5927), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Visitor role description",
                            LastModifiedOn = new DateTimeOffset(new DateTime(2022, 8, 9, 11, 31, 39, 34, DateTimeKind.Unspecified).AddTicks(5928), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Visitor",
                            NormalizedName = "VISITOR"
                        },
                        new
                        {
                            Id = new Guid("3680831c-40ab-49b3-ac95-b4fd96cc2262"),
                            ConcurrencyStamp = "7c1388df-7c2b-4cf9-87e3-3e310283abc5",
                            CreatedOn = new DateTimeOffset(new DateTime(2022, 8, 9, 11, 31, 39, 34, DateTimeKind.Unspecified).AddTicks(6040), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Administrator role description",
                            LastModifiedOn = new DateTimeOffset(new DateTime(2022, 8, 9, 11, 31, 39, 34, DateTimeKind.Unspecified).AddTicks(6041), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Administrator",
